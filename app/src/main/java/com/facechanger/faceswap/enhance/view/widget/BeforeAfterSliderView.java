 ...
 */
public class BeforeAfterSliderView extends FrameLayout {
    ...
    public BeforeAfterSliderView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public BeforeAfterSliderView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BeforeAfterSliderView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
