...
public final class TemplateItem implements Serializable {
    ...
    public TemplateItem(int id, String templateName, String prompt,
     ...
     */
    @NonNull
    public static TemplateItem fromJson(@NonNull JSONObject obj) {
     ...
     */
    @NonNull
    public static List<TemplateItem> fromJsonArray(@NonNull JSONArray array) {
        List<TemplateItem> items = new ArrayList<>(array.length());
     ...
     */
    @NonNull
    public static List<TemplateItem> fromApiResponse(@NonNull String json) throws org.json.JSONException {
        json = json.trim();
