 ...
 */
public final class AppFaceVideoFaceSwapResponse {
    ...
    private AppFaceVideoFaceSwapResponse(boolean success,
     ...
     */
    @NonNull
    public static AppFaceVideoFaceSwapResponse fromJson(@NonNull String json) throws org.json.JSONException {
        JSONObject obj = new JSONObject(json);
        return new AppFaceVideoFaceSwapResponse(
