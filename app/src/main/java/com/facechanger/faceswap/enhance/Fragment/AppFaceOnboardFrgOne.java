...
public class AppFaceOnboardFrgOne extends BaseAdFragment {
    ...
    public AppFaceOnboardFrgOne(OnButtonClickListener listenera, Integer currentIndex) {
        this.listener=listenera;
        this.currentIndex = currentIndex;
    }

    public AppFaceOnboardFrgOne() {
    ...
    private void getViews(View view) {
        ...
        if (currentIndex != null && currentIndex == 1) {
            ...
            ivOnboardImage.setImageResource(R.drawable.app_face_very_first_onboard_image);
            ...
            ivOnboardImage.setImageResource(R.drawable.app_face_second_onboard_image);
