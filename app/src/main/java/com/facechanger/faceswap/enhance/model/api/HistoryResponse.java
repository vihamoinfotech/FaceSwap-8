...
public final class HistoryResponse {
    ...
    private HistoryResponse(List<HistoryItem> items, int totalCount, int page,
    ...
    @NonNull
    public static HistoryResponse fromJson(@NonNull String json) throws org.json.JSONException {
