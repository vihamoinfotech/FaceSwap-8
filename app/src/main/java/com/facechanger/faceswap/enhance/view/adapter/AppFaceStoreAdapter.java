...
public class AppFaceStoreAdapter extends RecyclerView.Adapter<AppFaceStoreAdapter.ViewHolder> {
    ...
    public AppFaceStoreAdapter(List<Package> packages, OnPlanClickListener listener) {
    ...
    private void applyBadge(ViewHolder holder, int position) {
        ...
        if (totalItems >= 3 && position == totalItems - 2) {
            ...
            holder.tvBadge.setBackgroundResource(R.drawable.app_face_badge_popular_bg);
        } else if (totalItems >= 2 && position == totalItems - 1) {
            // Best Value badge
            holder.tvBadge.setVisibility(View.VISIBLE);
            holder.tvBadge.setText(R.string.face_app_best_value_text);
            holder.tvBadge.setBackgroundResource(R.drawable.app_face_badge_best_value_background);
        } else {
    ...
    private void applySelectionStyle(ViewHolder holder, int position) {
        if (position == selectedPosition) {
            holder.llPlanRoot.setBackgroundResource(R.drawable.app_plan_face_card_selected_bg);
        } else {
            holder.llPlanRoot.setBackgroundResource(R.drawable.app_plan_face_card_unselected_color);
        }
    }
