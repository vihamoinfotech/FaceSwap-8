 ...
 */
public final class AppFaceActivityNavHelper {

    private AppFaceActivityNavHelper() {
    ...
    public static void start(Activity from, Intent intent) {
        ...
        from.overridePendingTransition(R.anim.app_nav_fade_in, R.anim.app_nav_fade_out);
    }
}
