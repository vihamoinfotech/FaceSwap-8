...
public class FacebookEventsManager {
    ...
    private static FacebookEventsManager instance;
    private AppEventsLogger logger;

    private FacebookEventsManager() {}

    public static synchronized FacebookEventsManager getInstance() {
        if (instance == null) {
            instance = new FacebookEventsManager();
        }
        return instance;
    }
