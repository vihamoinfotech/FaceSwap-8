 ...
 */
public final class SplashDataResponse {
    ...
    private SplashDataResponse(String message, boolean isSuccess, @Nullable Data data) {
     ...
     */
    @NonNull
    public static SplashDataResponse fromJson(@NonNull String json) throws org.json.JSONException {
        ...
        Data data = root.has("data") && !root.isNull("data")
                ...
                : null;
        return new SplashDataResponse(message, success, data);
    }
