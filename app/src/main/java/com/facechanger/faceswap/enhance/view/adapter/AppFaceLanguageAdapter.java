...
public class AppFaceLanguageAdapter extends RecyclerView.Adapter<AppFaceLanguageAdapter.ViewHolder> {
    ...
    public AppFaceLanguageAdapter(List<LanguageItem> items, String selectedCode, OnLanguageClickListener listener) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_language_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (isSelected) {
            holder.itemView.setBackgroundResource(R.drawable.app_face_language_item_selected_color_border);
