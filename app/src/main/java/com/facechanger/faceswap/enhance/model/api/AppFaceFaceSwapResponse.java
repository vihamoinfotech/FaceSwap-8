 ...
 */
public final class AppFaceFaceSwapResponse {
    ...
    private AppFaceFaceSwapResponse(boolean success, String message,
     ...
     */
    @NonNull
    public static AppFaceFaceSwapResponse fromJson(@NonNull String json) throws org.json.JSONException {
        JSONObject obj = new JSONObject(json);
        return new AppFaceFaceSwapResponse(
