 ...
 */
public class AppFaceTemplateCache {
    
    private static List<AppFaceTemplateItem> currentTemplates = new ArrayList<>();

    public static void setCurrentTemplates(List<AppFaceTemplateItem> templates) {
        if (templates != null) {
    ...
    public static List<AppFaceTemplateItem> getCurrentTemplates() {
