...
public final class ApiClient {
     ...
     */
    public ApiCall get(@NonNull String endpoint, @Nullable ApiCallback callback) {
        DefaultApiCall apiCall = new DefaultApiCall();
     ...
     * @return ApiCall object to cancel the request
     */
    public ApiCall post(@NonNull String endpoint, @NonNull String jsonBody,
     ...
     * @return ApiCall object to cancel the request
     */
    public ApiCall multipartImageUpload(@NonNull String endpoint, @NonNull File imageFile, @NonNull String fileParameterName,
                                     @Nullable ApiCallback callback) {
        DefaultApiCall apiCall = new DefaultApiCall();
     ...
     * @return ApiCall object to cancel the request
     */
    public ApiCall multipartUpload(@NonNull String endpoint,
        ...
        if (timeoutMs > 0 && timeoutMs != READ_TIMEOUT_MS) {
            ...
            Retrofit customRetrofit = retrofit.newBuilder()
                    .client(customClient)
                    .build();
            ApiService customService = customRetrofit.create(ApiService.class);
    ...
    private void enqueueCall(@NonNull Call<ResponseBody> call,
                             @NonNull DefaultApiCall apiCall,
                             @Nullable ApiCallback callback) {
