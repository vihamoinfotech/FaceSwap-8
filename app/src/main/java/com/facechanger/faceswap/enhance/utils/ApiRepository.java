 ...
 * <p>
 * Each method wraps the {@link ApiClient} with proper endpoint paths,
...
public final class ApiRepository {
    ...
    private ApiRepository() { /* non-instantiable */ }
    ...
    public interface SplashDataCallback {
        void onSuccess(@NonNull SplashDataResponse response, String responseBody);
        void onError(@NonNull String errorMessage);
    }

    /** Callback for templates list API. */
    public interface TemplatesCallback {
        void onSuccess(@NonNull List<TemplateCategory> categories);
        void onError(@NonNull String errorMessage);
    }

    /** Callback for face swap API. */
    public interface FaceSwapCallback {
        void onSuccess(@NonNull FaceSwapResponse response);
        void onError(@NonNull String errorMessage);
    }
    ...
    /**
     * Configures the global {@link ApiClient} with the base URL.
     * Call once on app startup (e.g. in SplashActivity).
     */
    public static void initialise() {
        ApiClient.getInstance().setBaseUrl(BASE_URL);
    }
    ...
    public static void fetchSplashData(@NonNull Context context,
        ...
        DeviceUtils.getDeviceId(context, deviceId -> {
            try {

                JSONObject body = new JSONObject();
                body.put("deviceId", AppSystem.isDebugMode() ? (deviceId + "_test") : deviceId);
...
//                body.put("deviceId", AppSystem.isDebugMode() ? "DA5EAEB6DB860CE8EDC4C7BFE3344069" : deviceId);
                body.put("deviceType", DeviceUtils.getDeviceType());
                body.put("is_prm", AdManager.getInstance().isPremiumUser());
                body.put("appVersion", DeviceUtils.getAppVersion(context));
                body.put("referrer", referrer);

                ApiClient.getInstance().post("/api/User/splash_data", body.toString(),
                        new ApiClient.ApiCallback() {
                            @Override
                            public void onSuccess(@NonNull String responseBody) {
                                try {
                                    SplashDataResponse response = SplashDataResponse.fromJson(responseBody);
     ...
     */
    public static ApiCall fetchTemplates(@NonNull TemplatesCallback callback) {
        // The GetTemplatesRequest schema has no fields — send empty object
        String body = "{}";

        return ApiClient.getInstance().post("/api/templates/list", body,
                new ApiClient.ApiCallback() {
                    @Override
                    public void onSuccess(@NonNull String responseBody) {
                        try {
                            List<TemplateCategory> categories = TemplateCategory.fromApiResponse(responseBody);
    ...
    public static void faceSwapBasic(@NonNull File sourceImage,
        ...
        ApiClient.getInstance().multipartUpload(
                ...
                new ApiClient.ApiCallback() {
                    ...
                    public void onSuccess(@NonNull String responseBody) {
                        try {
                            FaceSwapResponse response = FaceSwapResponse.fromJson(responseBody);
    ...
    public static void removeBackground(@NonNull File imageFile,
                                        @NonNull FaceSwapCallback callback) {
        ApiClient.getInstance().multipartImageUpload(
    ...
    public static void textToImage(@NonNull String prompt,
        ...
        try {
            ...
            ApiClient.getInstance().post("/api/Image/text-to-image", body.toString(),
                    new ApiClient.ApiCallback() {
                        @Override
                        public void onSuccess(@NonNull String responseBody) {
                            try {
    ...
    public interface HistoryCallback {
        void onSuccess(@NonNull com.facechanger.faceswap.enhance.model.api.HistoryResponse response);
        void onError(@NonNull String errorMessage);
    }
     ...
     */
    public static ApiCall fetchHistory(int page, int pageSize,
                                    @NonNull HistoryCallback callback) {
        String url = BASE_URL + "/api/History?page=" + page + "&pageSize=" + pageSize;

        return ApiClient.getInstance().get(url, new ApiClient.ApiCallback() {
            @Override
            public void onSuccess(@NonNull String responseBody) {
                try {
                    com.facechanger.faceswap.enhance.model.api.HistoryResponse response =
                            com.facechanger.faceswap.enhance.model.api.HistoryResponse.fromJson(responseBody);
                    callback.onSuccess(response);
                } catch (Exception e) {
    ...
    public static void verifyPurchase(@NonNull String productId,
        ...
        try {
            ...
            ApiClient.getInstance().post("/api/purchases/verify", body.toString(),
                    new ApiClient.ApiCallback() {
                        @Override
                        public void onSuccess(@NonNull String responseBody) {
                            try {
                                ...
                                if (success) {
                                    ...
                                    if (newBalance >= 0) {
                                        SessionManager.getInstance().setCachedCredits(newBalance);
                                    }
    ...
    public static void verifyInAppPurchase(@NonNull String productId,
        ...
        try {
            ...
            ApiClient.getInstance().post("/api/purchases/log", body.toString(),
                    new ApiClient.ApiCallback() {
                        @Override
                        public void onSuccess(@NonNull String responseBody) {
                            try {
    ...
    public interface VideoFaceSwapCallback {
        void onSuccess(@NonNull com.facechanger.faceswap.enhance.model.api.VideoFaceSwapResponse response);
        void onError(@NonNull String errorMessage);
    }
    ...
    public static void videoFaceSwap(@NonNull File videoFile,
        ...
        ApiClient.getInstance().multipartUpload(
                ...
                new ApiClient.ApiCallback() {
                    ...
                    public void onSuccess(@NonNull String responseBody) {
                        try {
                            com.facechanger.faceswap.enhance.model.api.VideoFaceSwapResponse response =
                                    com.facechanger.faceswap.enhance.model.api.VideoFaceSwapResponse.fromJson(responseBody);
                            callback.onSuccess(response);
                        } catch (Exception e) {
