...
import com.facechanger.faceswap.enhance.AppFaceSwap;
 ...
 * </pre>
 */
public final class AppFaceAppSystem {
    ...
    public static boolean isRTLMode(@NonNull Context context) {
        String lang = AppFaceLocaleHelper.getSavedLanguage(context);
    ...
    public static void keepScreenOn(boolean enabled) {
        Application app = AppFaceSwap.getInstance();
        if (app == null) return;
