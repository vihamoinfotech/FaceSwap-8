...
public class AppFaceCoupleFaceSwapActivity extends BaseAppActivity {
    ...
    private void handleGenerateClick() {
        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                btnGenerate.setEnabled(true);
                AppFaceCoinManager.checkAndProceed(AppFaceCoupleFaceSwapActivity.this,
                        AppFaceLoadingActivity.ACTION_COUPLE_SWAP, () -> {
                    Intent intent = new Intent(AppFaceCoupleFaceSwapActivity.this, AppFaceLoadingActivity.class);
                    intent.putExtra("action", AppFaceLoadingActivity.ACTION_COUPLE_SWAP);
        ...
        permissionDialog = AppFaceAppDialogController.showPermissionDeniedDialog(
                ...
                new AppFaceOnDialogActionListener() {
                    ...
                    public void onPositiveClick() {
                        AppFacePermissionHelper.openAppSettings(AppFaceCoupleFaceSwapActivity.this);
                    }
