...
public class AppFaceMultiSwapActivity extends BaseAppActivity {
    ...
    private void handleGenerateClick() {
        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                btnGenerate.setEnabled(true);
                AppFaceCoinManager.checkAndProceed(AppFaceMultiSwapActivity.this,
                        AppFaceLoadingActivity.ACTION_MULTI_FACE_SWAP, () -> {
                    Intent intent = new Intent(AppFaceMultiSwapActivity.this, AppFaceLoadingActivity.class);
                    intent.putExtra("action", AppFaceLoadingActivity.ACTION_MULTI_FACE_SWAP);
        ...
        permissionDialog = AppFaceAppDialogController.showPermissionDeniedDialog(
                ...
                new AppFaceOnDialogActionListener() {
                    ...
                    public void onPositiveClick() {
                        AppFacePermissionHelper.openAppSettings(AppFaceMultiSwapActivity.this);
                    }
