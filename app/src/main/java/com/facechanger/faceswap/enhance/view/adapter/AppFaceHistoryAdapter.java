 ...
 */
public class AppFaceHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int VIEW_TYPE_ITEM = 0;
    private static final int VIEW_TYPE_LOADING = 1;

    private final List<AppFaceHistoryResponse.HistoryItem> items = new ArrayList<>();
    private final Context context;
    private boolean showLoadingFooter = false;
    private OnHistoryItemClickListener clickListener;

    public interface OnHistoryItemClickListener {
        void onItemClick(AppFaceHistoryResponse.HistoryItem item);
    }

    public AppFaceHistoryAdapter(@NonNull Context context) {
     ...
     */
    public void addItems(@NonNull List<AppFaceHistoryResponse.HistoryItem> newItems) {
     ...
     */
    public void setItems(@NonNull List<AppFaceHistoryResponse.HistoryItem> newItems) {
        items.clear();
        items.addAll(newItems);
    ...
    class HistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(@NonNull AppFaceHistoryResponse.HistoryItem item) {
            // Feature type
            ...
            if (item.hasValidUrl()) {
                Glide.with(context)
                        .load(AppFaceGlideHelper.authorizedUrl(item.getResultUrl()))
