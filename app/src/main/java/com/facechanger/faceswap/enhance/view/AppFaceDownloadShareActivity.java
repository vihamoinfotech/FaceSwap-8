...
import com.facechanger.faceswap.enhance.view.widget.AppFaceBeforeAfterSliderView;
 ...
 * </ul>
 */
public class AppFaceDownloadShareActivity extends BaseAppActivity {
    ...
    private void setupPreview() {
        AppFaceBeforeAfterSliderView slider = findViewById(R.id.beforeAfterSlider);
    ...
    private Object buildGlideModel(@Nullable String source) {
        ...
        if (source.startsWith("http://") || source.startsWith("https://")) {
            ...
            return AppFaceGlideHelper.authorizedUrl(source);
    ...
    private void openEditScreen() {
        Intent intent = new Intent(this, AppFaceEditImageActivity.class);
    ...
    private void handleShareClick() {
        ...
        executor.execute(() -> {
            try {
                ...
                runOnUiThread(() -> AppFaceAppSystem.showDebugToast(this, "Share error: " + e.getMessage()));
            }
        });
    }
