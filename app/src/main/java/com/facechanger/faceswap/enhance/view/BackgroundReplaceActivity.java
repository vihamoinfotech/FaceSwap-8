...
public class BackgroundReplaceActivity extends BaseAppActivity {
    ...
    private void handleGenerate() {
        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                btnGenerate.setEnabled(true);
                CoinManager.checkAndProceed(BackgroundReplaceActivity.this,
                        LottieLoadingActivity.ACTION_BG_REPLACE, () -> {
                    Intent intent = new Intent(BackgroundReplaceActivity.this, LottieLoadingActivity.class);
                    intent.putExtra("action", LottieLoadingActivity.ACTION_BG_REPLACE);
        ...
        permissionDialog = AppDialogController.showPermissionDeniedDialog(
                ...
                new OnDialogActionListener() {
                    ...
                    public void onPositiveClick() {
                        PermissionHelper.openAppSettings(BackgroundReplaceActivity.this);
                    }
